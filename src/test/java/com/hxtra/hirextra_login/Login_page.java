...
public class Login_page {
	...
	public static void main(String[] args) throws Exception {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\HX-31\\eclipse-workspace\\com.hxtra.hirextra\\src\\main\\java\\servers\\chromedriver.exe");
...
//		int x=re.nextInt(452315);
		...
		indu.click();
		Thread.sleep(3000);
		Select se=new Select(indu);
		se.selectByVisibleText(" Software Engineer ");
